...
Route::get('/user', function (Request $request) {
    return $request->user()->load('doctorProfile');
...
Route::post('/doctors/availability', [\App\Http\Controllers\Api\AvailabilityController::class, 'store'])->middleware('auth:sanctum');
